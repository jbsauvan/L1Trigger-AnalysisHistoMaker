...
/*****************************************************************/
void AnHiMa::tokenize(const string& str,
        vector<string>& tokens,
...
/*****************************************************************/
string AnHiMa::intToString(int n)
/*****************************************************************/
{
    ostringstream oss;
    oss << n;
...
/*****************************************************************/
void AnHiMa::findAndReplace(string& sInput, string sFind, string sReplace )
/*****************************************************************/
{
    size_t itPos = 0; 
...
/*****************************************************************/
void AnHiMa::strip(std::string& sInput)
/*****************************************************************/
{
